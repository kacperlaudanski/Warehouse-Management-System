...
export default function SidebarMenu() {
  ...
  return (
    <aside
      ...
      } transition-all duration-300 ease-in-out pt-10 px-2 flex items-center flex-col h-screen bg-neutral-100 fixed z-30 ${isSidebarShown && `shadow-[8px_0px_9px_0px_#00000024]`}`}
